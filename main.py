...
Original file is located at
    https://colab.research.google.com/drive/1IkMDMfgf_6hzfazqF70pjM3O_YGCOLVC
...
print("It will be ", str(celsius) + " in Celsius")
...
if number2 != 0:
    if number1 % number2 == 0:
        ...
        print("You can't divide the first by the second.")
...
if side1 + side2 > side3 and side1 + side3 > side2 and side2 + side3 > side1:
    ...
    print("These side lengths can't be triangle.")
